    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_file1', models.FileField(null=True, upload_to='shop-images/')),
                ('comment1', models.CharField(blank=True, max_length=1000)),
                ('image_file2', models.FileField(null=True, upload_to='shop-images/')),
                ('comment2', models.CharField(blank=True, max_length=1000)),
                ('image_file3', models.FileField(null=True, upload_to='shop-images/')),
                ('comment3', models.CharField(blank=True, max_length=1000)),
                ('image_file4', models.FileField(null=True, upload_to='shop-images/')),
