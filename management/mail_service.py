...
def send_email_alert_to_all_shopkeepers(email_list):
    for email in email_list:
        ...
        message = MIMEMultipart("alternative")
        message["Subject"] = "BharatOff - Download your designs"
        message["From"] = sender_email
        message["To"] = receiver_email
        text = "Hi,\nPlease download your design"
        html = """
        <!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
        <head>
        ...
        * {
        ...
        <div style="line-height: 150%; text-align: left; word-wrap: break-word;">
            <p style="line-height: 150%; font-size: 14px;"><span style="font-size: 16px; line-height: 24px; color: #282828;">Hi, we have created a very unique design just for you for upcoming festival. Please find in by following that button.</span></p>
        </div>
        ...
        <div style="color: #292929; line-height: 160%; text-align: left; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 160%;">&nbsp;</p>
        <p style="font-size: 14px; line-height: 160%;">NOTE - BharatOff provides the designs for <b>no charge</b>. Please do not pay any extra charges for it.</p>
        </div>
